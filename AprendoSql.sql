Create DataBase AprendoSQlUnaSemana
...
create table  agenda(
  ...
  ilect * from agenda 
nsert into agenda (apellido, nombre, domicilio, telefono) values ('Moreno','Alberto','Colon 123','4234567');
...
if object_id('alumnos') is not null
 ...
 select ciudad,sexo, count(*) as cantidad,
  ...
  /* 38 - Modificador del group by (with rollup) */
 ...
 /* 39 - Modificador del group by (with cube) */
...
-- 66- Combinación externa izquierda (left join)
 ...
 -- 68 - Combinación externa completa (full join)
 ...
 -- 69- Combinaciones cruzadas (cross join)
